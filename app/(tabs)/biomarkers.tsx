...
import { View, Text, StyleSheet, TouchableOpacity, ActivityIndicator, Platform, Image, ImageBackground, Dimensions } from 'react-native';
            ...
            >
              <SafeAreaView style={styles.container}>
                ...
                <View style={styles.fixedContent}>
                  <View style={[GlobalStyles.headerContainer, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 }]}>
                    <View>
                      <Text style={GlobalStyles.headerTitle}>{i18n.t('analysis.title')}</Text>
                      <Text style={GlobalStyles.headerSubtitle}>{i18n.t('analysis.subtitle')}</Text>
                    </View>
                  ...
                  {results && (
                    <View style={styles.resultsContainer}>
                      ...
                      <View style={{ height: Dimensions.get('window').height * 0.22, marginTop: -110 }}>
